...
const formatValue = (value, key = "") => {
  ...
  if (/amount|paid|pending/i.test(key) && !Number.isNaN(Number(value))) return `₹${Number(value).toLocaleString("en-IN")}`;
