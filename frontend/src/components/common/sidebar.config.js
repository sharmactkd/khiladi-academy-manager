...
export const ownerNavigation = [
  {
    ...
    children: [
      ...
      { id: "public-academy-profile", label: "Public Profile", to: "/academy/public-profile", roles: OWNER_ROLES, icon: Globe2 },
      { id: "admission-enquiries", label: "Admissions & Enquiries", to: "/admissions/enquiries", roles: OWNER_ROLES, icon: Inbox },
      { id: "admission-follow-ups", label: "Follow-up Dashboard", to: "/admissions/follow-ups", roles: OWNER_ROLES, icon: CalendarClock },
