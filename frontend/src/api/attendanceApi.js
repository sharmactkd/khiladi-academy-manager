...
export const attendanceApi = {
  ...
  getMonthlyRegister: (params = {}, config = {}) =>
    api.get("/attendance/monthly-register", { ...config, params }),
  ...
  moveMonthlyRow: (payload) => api.patch("/attendance/monthly-register/order", payload),
