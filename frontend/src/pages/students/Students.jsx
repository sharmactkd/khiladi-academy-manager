...
const Students = () => {
  ...
  return (
    <div className="page students-page">
      ...
      <StudentsTable students={students} loading={loading} loadingMore={loadingMore} pagination={pagination}
        selectable selectedIds={selectedIds} allVisibleSelected={allVisibleSelected}
        toggleSelectAll={toggleSelectAll} toggleSelectOne={toggleSelectOne}
        handleBulkDelete={handleBulkDelete} bulkDeleting={bulkDeleting}
        handleStudentsScroll={handleStudentsScroll} handleStatusToggle={handleStatusToggle}
