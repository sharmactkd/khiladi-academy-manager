...
export const REPORT_TYPES = [
  ...
  { id: "fees", label: "Fee Statement", shortLabel: "Fees", description: "Collections, pending amounts, modes and receipt records.", icon: CreditCard, tone: "green", ownerOnly: true, statuses: [{ value: "paid", label: "Paid" }, { value: "partial", label: "Partial" }, { value: "due", label: "Due" }, { value: "cancelled", label: "Cancelled" }] },
