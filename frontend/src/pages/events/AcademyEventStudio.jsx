...
const DAN_RANKS = TAEKWONDO_DAN_RANKS;
...
const BeltField = ({ disabled, label, onChange, value }) => (
  <div className={styles.beltTileField}>
    <span>{label}</span>
    <BeltTileSelector compact disabled={disabled} value={value} onChange={onChange} />
  </div>
);
