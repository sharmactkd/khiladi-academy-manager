...
const env = {
  ...
  FEE_INTEGRITY_SYNC_ENABLED: process.env.FEE_INTEGRITY_SYNC_ENABLED !== "false",
  FEE_INTEGRITY_SYNC_INTERVAL_MINUTES: Math.min(
    Math.max(Number(process.env.FEE_INTEGRITY_SYNC_INTERVAL_MINUTES) || 360, 15),
    1440
  ),
