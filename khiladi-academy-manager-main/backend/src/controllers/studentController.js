...
export const getStudents = asyncHandler(async (req, res) => {
  ...
  const buildStudentsQuery = () => Student.find(query)
    ...
    .populate("branch", "branchName branchCode whatsappGroupLink currencyCode currencySymbol currencyCountryCode")
    .populate(
      "batch",
      "batchName martialArt whatsappGroupLink isActive monthlyFee quarterlyFee annualFee"
    )
    .sort({ createdAt: -1 })
    .lean();
