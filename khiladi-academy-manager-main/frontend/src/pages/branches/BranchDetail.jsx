...
import {
  ArrowLeft, Award, Building2, CalendarCheck2, CalendarDays, CheckCircle2, MessageCircleMore,
      ...
      <div className="branch-detail-primary-grid">
        ...
        <section className="branch-detail-card">
          ...
          <div className="branch-detail-items">
            ...
            <DetailItem icon={MessageCircleMore} label="WhatsApp Group Link">{branch?.whatsappGroupLink ? <a href={branch.whatsappGroupLink} target="_blank" rel="noopener noreferrer">Open saved group</a> : "Not added"}</DetailItem>
          </div>
        </section>
      </div>
