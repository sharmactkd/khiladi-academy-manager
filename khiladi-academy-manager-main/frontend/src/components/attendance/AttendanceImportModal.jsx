    ...
    <section className={styles.modal}>
      ...
      <div className={styles.body}>
        ...
        {step === 3 && <>
          ...
          <AttendanceMatchSections groups={reviewGroups} historyGroups={historyGroups} availableStudents={availableStudents} onResolve={setResolution} onCreateAll={createAllUnmatched} busy={busy} />
        </>}
